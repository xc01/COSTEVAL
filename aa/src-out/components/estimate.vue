          ...
          <el-form>
            <el-form-item label="KDSI" :label-width="formLabelWidth">
              <el-input
                type="number"
                step="0.01"
                v-model:value="cocomo81_form.kdsi"
            ...
            <el-row>
              ...
              <el-col :span="16">
                <cost-driver-assess
                  name="RELY"
                  v-model:value="cocomo81_form.costDriver.rely"
                  :wid="formLabelWidth"
                  :disableList="[5]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="DATA"
                  v-model:value="cocomo81_form.costDriver.data"
                  :wid="formLabelWidth"
                  :disableList="[0, 5]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="CPLX"
                  v-model:value="cocomo81_form.costDriver.cplx"
                  :wid="formLabelWidth"
                  :disableList="[]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="TIME"
                  v-model:value="cocomo81_form.costDriver.time"
                  :wid="formLabelWidth"
                  :disableList="[0, 1]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="STOR"
                  v-model:value="cocomo81_form.costDriver.virt"
                  :wid="formLabelWidth"
                  :disableList="[0, 1]"
                >
                </cost-driver-assess>
                ...
                <cost-driver-assess
                  name="TURN"
                  v-model:value="cocomo81_form.costDriver.turn"
                  :wid="formLabelWidth"
                  :disableList="[0, 5]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="ACAP"
                  v-model:value="cocomo81_form.costDriver.acap"
                  :wid="formLabelWidth"
                  :disableList="[5]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="AEXP"
                  v-model:value="cocomo81_form.costDriver.aexp"
                  :wid="formLabelWidth"
                  :disableList="[5]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="PCAP"
                  v-model:value="cocomo81_form.costDriver.pcap"
                  :wid="formLabelWidth"
                  :disableList="[5]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="VEXP"
                  v-model:value="cocomo81_form.costDriver.vexp"
                  :wid="formLabelWidth"
                  :disableList="[4, 5]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="LEXP"
                  v-model:value="cocomo81_form.costDriver.lexp"
                  :wid="formLabelWidth"
                  :disableList="[4, 5]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="MODP"
                  v-model:value="cocomo81_form.costDriver.modp"
                  :wid="formLabelWidth"
                  :disableList="[5]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="TOOL"
                  v-model:value="cocomo81_form.costDriver.tool"
                  :wid="formLabelWidth"
                  :disableList="[5]"
                >
                </cost-driver-assess>
                <cost-driver-assess
                  name="SCED"
                  v-model:value="cocomo81_form.costDriver.sced"
                  :wid="formLabelWidth"
                  :disableList="[5]"
                >
                </cost-driver-assess>
        ...
        >
          <el-form>
            <el-form-item label="EI" :label-width="formLabelWidth">
              <el-input
                type="number"
                v-model:value="cocomoii_form.ei"
            ...
            <el-form-item label="EO" :label-width="formLabelWidth">
              <el-input
                type="number"
                v-model:value="cocomoii_form.eo"
            ...
            <el-form-item label="ILF" :label-width="formLabelWidth">
              <el-input
                type="number"
                v-model:value="cocomoii_form.ilf"
            ...
            <el-form-item label="EIF" :label-width="formLabelWidth">
              <el-input
                type="number"
                v-model:value="cocomoii_form.eif"
            ...
            <el-form-item label="EQ" :label-width="formLabelWidth">
              <el-input
                type="number"
                v-model:value="cocomoii_form.eq"
          ...
          <el-form>
            <el-form-item label="KDSI" :label-width="formLabelWidth">
              <el-input
                type="number"
                step="0.01"
                v-model:value="regression_form.kdsi"
                placeholder="请输入软件代码量估计"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          ...
          <el-form>
            <el-form-item label="KDSI" :label-width="formLabelWidth">
              <el-input
                type="number"
                step="0.01"
                v-model:value="analogy_form.kdsi"
                placeholder="请输入软件代码量估计"
                autocomplete="off"
              ></el-input>
            </el-form-item>
