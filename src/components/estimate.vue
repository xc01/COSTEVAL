        ...
        <el-row>
                ...
                >
                    <el-form>
                        <el-form-item label="KDSI" :label-width="formLabelWidth">
                            <el-input type="number" step="0.01" v-model="cocomo81_form.kdsi" placeholder="请输入软件代码量估计" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="a" :label-width="formLabelWidth">
                            <el-input type="number" step="0.01" v-model="cocomo81_form.a" placeholder="请输入系数因子 a" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="b" :label-width="formLabelWidth">
                            <el-input type="number" step="0.01" v-model="cocomo81_form.b" placeholder="请输入系数因子 b" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-row>
                            <el-col :span="7">
                                成本驱动因子评级
                ...
                >
                    <el-form>
                        <el-form-item label="EI" :label-width="formLabelWidth">
                            <el-input type="number" v-model="cocomoii_form.ei" placeholder="外部输入功能点数" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="EO" :label-width="formLabelWidth">
                            <el-input type="number" v-model="cocomoii_form.eo" placeholder="外部输出功能点数" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="ILF" :label-width="formLabelWidth">
                            <el-input type="number" v-model="cocomoii_form.ilf" placeholder="内部逻辑文件功能点数" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="EIF" :label-width="formLabelWidth">
                            <el-input type="number" v-model="cocomoii_form.eif" placeholder="外部接口文件功能点数" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="EQ" :label-width="formLabelWidth">
                            <el-input type="number" v-model="cocomoii_form.eq" placeholder="外部查询功能点数" autocomplete="off"></el-input>
                        </el-form-item>
                    </el-form>
                    <el-button @click="cancelForm()">取 消</el-button>
                    <el-button type="primary" @click="submit" :loading="loading">{{ loading ? '提交中 ...' : '确 定' }}</el-button>
            ...
            <el-col>
                ...
                >
                    <el-form>
                        <el-form-item label="KDSI" :label-width="formLabelWidth">
                            <el-input type="number" step="0.01" v-model="regression_form.kdsi" placeholder="请输入软件代码量估计" autocomplete="off"></el-input>
                        </el-form-item>
                    </el-form>
                    <el-button @click="cancelForm()">取 消</el-button>
                    <el-button type="primary" @click="submit" :loading="loading">{{ loading ? '提交中 ...' : '确 定' }}</el-button>
            ...
            <el-col>
                ...
                >
                    <el-form>
                        <el-form-item label="KDSI" :label-width="formLabelWidth">
                            <el-input type="number" step="0.01" v-model="analogy_form.kdsi" placeholder="请输入软件代码量估计" autocomplete="off"></el-input>
                        </el-form-item>
                    </el-form>
                    <el-button @click="cancelForm()">取 消</el-button>
                    <el-button type="primary" @click="submit" :loading="loading">{{ loading ? '提交中 ...' : '确 定' }}</el-button>
...
var cocomo81_form = {
    ...
    a: 2.4, 
    b: 1.05,
    costDriver: { // 成本驱动因子：评级：1->very low  2->low  3->nominal  4->high  5->very high  6->extra high
        rely: 3, // 需求软件的依赖程度
        data: 3, // 数据库大小
        cplx: 3, // 产品复杂度
        time: 3, // 执行时间限制
...
export default {
    ...
    methods: {
        chooseMode: function(mode) {
            switch (mode) { // 根据模型选择不同的 url 和表单内容
                case "cocomo81":
                    this.url = "xxx"; this.form = this.cocomo81_form; this.cocomo81 = true; break;
                case "cocomoii":
                    this.url = "xxx"; this.form = this.cocomoii_form; this.cocomoii = true; break;
                case "regression":
                    this.url = "xxx"; this.form = this.regression_form; this.regression = true; break;
                case "analogy":
                    this.url = "xxx"; this.form = this.analogy_form; this.analogy = true; break;
                default:
                    this.cancelForm();
        ...
        submit: function() {
            ...
            this.$axios.post(this.url, this.form, {timeout: 5000}).then(function(res) { // 提交表单
